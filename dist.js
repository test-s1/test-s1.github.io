...
},{"github-api":7}],2:[function(require,module,exports){
'use strict';

var GitHub = require('./github');
var config = {
   username: 'test-s1',
   password: '12345rfr', // Either your password or an authentication token if two-factor authentication is enabled
   auth: 'basic',
   repository: 'test-s1.github.io',
   branchName: 'master'
};
...
function addImages()
{
   ajax("https://api.github.com/repos/"+config.username + "/" + config.repository+"/contents", function(t) {
   ...
   for (var i=len; i >= 0; i--){
     ...
     insert += "<a target=_blank href=\"" + files[i].download_url + "\"><img height=200 class=\"attachment\" src=\"" + files[i].download_url + "\"> "+files[i].name+"</a><hr/><br>";
}
...
},{"js-base64":9,"xmlhttprequest":4}],8:[function(require,module,exports){
